  ...
  if (type === 'horizontal' && hasContent) {
    return (
      <div
        ...
        {...restProps}
      >
        {orientation !== 'right' && <div style={lineStyle} className="cross-divider-line cross-divider-line-left" />}
        <div style={textContainerStyle} className="cross-divider-text">
          {children}
        </div>
        {orientation !== 'left' && <div style={lineStyle} className="cross-divider-line cross-divider-line-right" />}
      </div>
    );
  }
